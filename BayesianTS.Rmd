...
\subsubsection{AR(p)}
The Stan code is as follows:
```{stan, output.var="ARp", eval = TRUE,  message = FALSE}
data {
...
```{stan,  output.var="ARCH1", eval = TRUE,  message = FALSE}
data{
...
```{stan,  output.var="MAq", eval = TRUE, message = FALSE}
data {
...
```{stan, output.var = 'ARMApq', eval = TRUE}
data {
